SCHEMA = {
    ...
    "schema": {
        ...
        "patternProperties": {"^x-": {"$ref": "#/defs/vendorExtension"}},
        "properties": {
            "swagger": {
                "type": "string",
                "enum": ["2.0"],
            ...
            "schemes": {"$ref": "#/defs/schemesList"},
            "consumes": {
                "description": "A list of MIME types accepted by the API.",
                "allOf": [{"$ref": "#/defs/mediaTypeList"}],
            },
            "produces": {
            ...
            "responses": {"$ref": "#/defs/responseDefinitions"},
            "security": {"$ref": "#/defs/security"},
            "securityDefinitions": {"$ref": "#/defs/securityDefinitions"},
            "tags": {
                "type": "array",
                "items": {"$ref": "#/defs/tag"},
                "uniqueItems": True,
        ...
        "defs": {
            ...
            "operation": {
                ...
                "properties": {
                    ...
                    "parameters": {"$ref": "#/defs/parametersList"},
            ...
            "responses": {
                ...
                "additionalProperties": False,
                "patternProperties": {
                    "^([0-9]{3})$|^(default)$": {"$ref": "#/defs/responseValue"},
                    "^x-": {"$ref": "#/defs/vendorExtension"},
                },
                "not": {
                    "type": "object",
            ...
            "responseValue": {
                "oneOf": [{"$ref": "#/defs/response"}, {"$ref": "#/defs/jsonReference"}]
            },
            "response": {
                "type": "object",
            ...
            "header": {
                ...
                "properties": {
                    ...
                    "format": {"type": "string"},
                    "items": {"$ref": "#/defs/primitivesItems"},
                    "collectionFormat": {"$ref": "#/defs/collectionFormat"},
                    "default": {"$ref": "#/defs/default"},
                    "maximum": {"$ref": "#/defs/maximum"},
                    "exclusiveMaximum": {"$ref": "#/defs/exclusiveMaximum"},
                    "minimum": {"$ref": "#/defs/minimum"},
                    "exclusiveMinimum": {"$ref": "#/defs/exclusiveMinimum"},
                    "maxLength": {"$ref": "#/defs/maxLength"},
                    "minLength": {"$ref": "#/defs/minLength"},
                    "pattern": {"$ref": "#/defs/pattern"},
                    "maxItems": {"$ref": "#/defs/maxItems"},
                    "minItems": {"$ref": "#/defs/minItems"},
                    "uniqueItems": {"$ref": "#/defs/uniqueItems"},
                    "enum": {"$ref": "#/defs/enum"},
                    "multipleOf": {"$ref": "#/defs/multipleOf"},
                    "description": {"type": "string"},
                },
                "patternProperties": {"^x-": {"$ref": "#/defs/vendorExtension"}},
            },
            ...
            "queryParameterSubSchema": {
                ...
                "properties": {
                    ...
                    "format": {"type": "string"},
                    "items": {"$ref": "#/defs/primitivesItems"},
                    "collectionFormat": {"$ref": "#/defs/collectionFormatWithMulti"},
                    "default": {"$ref": "#/defs/default"},
                    "maximum": {"$ref": "#/defs/maximum"},
                    "exclusiveMaximum": {"$ref": "#/defs/exclusiveMaximum"},
                    "minimum": {"$ref": "#/defs/minimum"},
            ...
            "schema": {
                ...
                "properties": {
                    ...
                    "additionalProperties": {
                        "anyOf": [{"$ref": "#/defs/schema"}, {"type": "boolean"}],
                        "default": {},
                    },
                    "type": {
